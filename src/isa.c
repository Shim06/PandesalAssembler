...
const InstructionMnemonic instruction_mnemonic_map[MNEMONIC_COUNT] = {
    ...
    {"CPX", MNEM_CPX}, {"CPY", MNEM_CPY}, {"INC", MNEM_INC}, {"ADD", MNEM_ADD}, {"SUB", MNEM_SUB}
};  
...
const uint16_t opcode_table[MNEMONIC_COUNT][ADDR_COUNT] = {
    ...
    [MNEM_ASL] =
    {
        [ADDR_ACCUMULATOR] = ASL_A,
        [ADDR_IMPLIED] = INVALID_OPCODE,
        [ADDR_IMMEDIATE] = INVALID_OPCODE,
        [ADDR_ABSOLUTE] = ASL_ABS,
        [ADDR_ABSOLUTEX] = INVALID_OPCODE,
        [ADDR_ABSOLUTEY] = INVALID_OPCODE
    },
    [MNEM_LSR] =
    {
        [ADDR_ACCUMULATOR] = LSR_A,
        [ADDR_IMPLIED] = INVALID_OPCODE,
        [ADDR_IMMEDIATE] = INVALID_OPCODE,
        [ADDR_ABSOLUTE] = LSR_ABS,
        [ADDR_ABSOLUTEX] = INVALID_OPCODE,
        [ADDR_ABSOLUTEY] = INVALID_OPCODE
    },
    [MNEM_ROL] =
    {
        [ADDR_ACCUMULATOR] = ROL_A,
        [ADDR_IMPLIED] = INVALID_OPCODE,
        [ADDR_IMMEDIATE] = INVALID_OPCODE,
        [ADDR_ABSOLUTE] = ROL_ABS,
        [ADDR_ABSOLUTEX] = INVALID_OPCODE,
        [ADDR_ABSOLUTEY] = INVALID_OPCODE
    },
    [MNEM_ROR] =
    {
        [ADDR_ACCUMULATOR] = ROR_A,
        [ADDR_IMPLIED] = INVALID_OPCODE,
        [ADDR_IMMEDIATE] = INVALID_OPCODE,
    ...
    [MNEM_ADD] =
    {
        [ADDR_ACCUMULATOR] = INVALID_OPCODE,
        [ADDR_IMPLIED] = INVALID_OPCODE,
        [ADDR_IMMEDIATE] = ADD_IMM,
        [ADDR_ABSOLUTE] = ADD_ABS,
        [ADDR_ABSOLUTEX] = INVALID_OPCODE,
        [ADDR_ABSOLUTEY] = INVALID_OPCODE
    },
    [MNEM_SUB] =
    {
        [ADDR_ACCUMULATOR] = INVALID_OPCODE,
        [ADDR_IMPLIED] = INVALID_OPCODE,
        [ADDR_IMMEDIATE] = SUB_IMM,
        [ADDR_ABSOLUTE] = SUB_ABS,
        [ADDR_ABSOLUTEX] = INVALID_OPCODE,
        [ADDR_ABSOLUTEY] = INVALID_OPCODE
    }
};
...
AddressingMode get_addressing_mode(Token* tokens, int start, int count)
{
    ...
    if (op1.type == TOKEN_IMMEDIATE) return ADDR_IMMEDIATE;
    if (op1.type == TOKEN_REGISTER && op1.text[0] == 'A') return ADDR_ACCUMULATOR;

    // Absolute addressing
    if (op1.type == TOKEN_ADDRESS || op1.type == TOKEN_IDENTIFIER)
    {
        if (op2.type == TOKEN_COMMA && strcmp(op3.text, "X") == 0) return ADDR_ABSOLUTEX;
        if (op2.type == TOKEN_COMMA && strcmp(op3.text, "Y") == 0) return ADDR_ABSOLUTEY;
